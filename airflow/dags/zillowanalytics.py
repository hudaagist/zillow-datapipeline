...
s3_bucket = "cleaned-data-zone-csv-bucket-gista"
...
def extract_zillow_data(**kwargs):
    ...
    output_file_path = f"/home/ubuntu/response_data_{df_string}.json"
...
with DAG(
    ...
    extract_zillow_data >> load_to_s3 >> is_file_in_s3_available >> transfer_s3_to_redshift
